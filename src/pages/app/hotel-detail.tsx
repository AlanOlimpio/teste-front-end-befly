    ...
    return (
        <>
            ...
            <div className="flex flex-1 flex-col gap-4  pt-0 px-8 max-sm:px-5">
                <div className="grid auto-rows-min gap-4 md:grid-cols-2 pb-6">
                    ...
                    <div className="flex flex-col gap-4">
                        {hotel.data.latitude_fornecedor_auxiliar && hotel.data.longitude_fornecedor_auxiliar && (
                            <Mapa
                                mapRef={mapRef}
                                latitude={parseFloat(hotel.data.latitude_fornecedor_auxiliar)}
                                longitude={parseFloat(hotel.data.longitude_fornecedor_auxiliar)}
                                endereco={hotel.data.endereco_completo_auxiliar}
